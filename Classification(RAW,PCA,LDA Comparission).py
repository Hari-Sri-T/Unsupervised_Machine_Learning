...
print("Accuracy with PCA 2 components:", metrics.accuracy_score(y_test, y_pred_pca))
# %%
...
# %%
y_pred_pca = clf_pca.predict(X_test_pca)
print("Accuracy with PCA 3 components:", metrics.accuracy_score(y_test, y_pred_pca))
# %%
## Using LDA
...
print("Accuracy with LDA:", metrics.accuracy_score(y_test, y_pred_lda))
